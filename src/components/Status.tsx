  ...
  return (
    <>
      <div className="bg-gray-700 p-3 rounded-lg shadow-md text-center w-full max-w-xs">
        ...
        <p className="text-xs text-blue-300 min-h-[3em] break-words">
          {gestureStatus}
        </p>
      ...
      <div className="mt-6 p-4 bg-gray-700 rounded-lg shadow-lg w-full max-w-4xl">
        ...
        <ul className="list-disc list-inside text-sm space-y-1">
          <li>
            ...
            <code className="bg-gray-600 px-1 rounded text-xs">
          ...
          <li>
            **Pinch to Zoom**: Bring thumb and index finger together. Move apart
            to zoom in, closer to zoom out.
          </li>
          <li>
            **Pan Map**: Make a "Pointing Up" or custom pointing gesture, then
            move your hand.
          </li>
